...
Here is the first option.  Below is a gist that shows two different ways of getting it. They both **require** that the package be available as a source file (.tar.gz or .zip) AND that the package is located on CRAN.
