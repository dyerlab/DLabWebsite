...
```{r}
#| fig-cap: Current progress on bioinformatic workflows.

tmp <- progress %>% select( Population, N, Sites, SNPs) %>% arrange( -SNPs )
...
tmp$Mapped[ tmp$Population == "G" ] <- round(77 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "H" ] <- round(24 / tmp$N[ tmp$Population == "H"] * 100.0)
tmp$Mapped[ tmp$Population == "I" ] <- round(0 / tmp$N[ tmp$Population == "I"] * 100.0)
tmp$Mapped[ tmp$Population == "L" ] <- round(10 / tmp$N[ tmp$Population == "L"] * 100.0)
tmp$Mapped[ tmp$Population == "M" ] <- round(121 / tmp$N[ tmp$Population == "M"] * 100.0)
tmp$Mapped[ tmp$Population == "N" ] <- round(53 / tmp$N[ tmp$Population == "N"] * 100.0)
tmp$Mapped[ tmp$Population == "V" ] <- round(4 / tmp$N[ tmp$Population == "V"] * 100.0)
