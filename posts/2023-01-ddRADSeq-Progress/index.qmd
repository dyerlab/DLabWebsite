...
tmp$Mapped[ tmp$Population == "H" ] <- round(53 / tmp$N[ tmp$Population == "H"] * 100.0)
tmp$Mapped[ tmp$Population == "I" ] <- round(8 / tmp$N[ tmp$Population == "I"] * 100.0)
tmp$Mapped[ tmp$Population == "L" ] <- round( (9+5+6) / tmp$N[ tmp$Population == "L"] * 100.0)
