...
tmp$Mapped[ tmp$Population == "G" ] <- round(69 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "H" ] <- round(14 / tmp$N[ tmp$Population == "H"] * 100.0)
...
tmp$Mapped[ tmp$Population == "M" ] <- round(113 / tmp$N[ tmp$Population == "M"] * 100.0)
tmp$Mapped[ tmp$Population == "N" ] <- round(48 / tmp$N[ tmp$Population == "N"] * 100.0)
