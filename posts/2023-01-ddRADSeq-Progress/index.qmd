...
tmp$Mapped[ tmp$Population == "G" ] <- round(78 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "H" ] <- round(50 / tmp$N[ tmp$Population == "H"] * 100.0)
tmp$Mapped[ tmp$Population == "I" ] <- round(1 / tmp$N[ tmp$Population == "I"] * 100.0)
tmp$Mapped[ tmp$Population == "L" ] <- round( (9+2+1) / tmp$N[ tmp$Population == "L"] * 100.0)
tmp$Mapped[ tmp$Population == "M" ] <- round(129 / tmp$N[ tmp$Population == "M"] * 100.0)
tmp$Mapped[ tmp$Population == "N" ] <- round(53 / tmp$N[ tmp$Population == "N"] * 100.0)
tmp$Mapped[ tmp$Population == "V" ] <- round(21 / tmp$N[ tmp$Population == "V"] * 100.0)
