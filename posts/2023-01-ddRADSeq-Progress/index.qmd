...
tmp$Mapped[ tmp$Population == "G" ] <- round(32 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "H" ] <- round(12 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "I" ] <- round(0 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "L" ] <- round(7 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "M" ] <- round(77 / tmp$N[ tmp$Population == "G"] * 100.0)
tmp$Mapped[ tmp$Population == "N" ] <- round(13 / tmp$N[ tmp$Population == "G"] * 100.0)
